...
const Page = () => {
    ...
    const loading = useSelector((state) => state.data.loading); // ✅ get loading from redux
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-white p-6">
            <div className="w-full max-w-4xl bg-white rounded-xl p-8">
                <div className="flex items-center justify-between mb-10">
                    <h1 className="text-[35px] font-bold" style={{ color: '#5C4A3A' }}>
                        Add New Product
                    </h1>
                </div>
                ...
                <div className="space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3.5 bg-white border rounded-lg outline-none text-gray-800 placeholder-gray-400"
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows="4"
                            className="w-full px-4 py-3.5 bg-white border rounded-lg outline-none text-gray-800 placeholder-gray-400 resize-none"
                            style={{ borderColor: '#E8DCC8' }}
                        />
                    ...
                    <div className="flex gap-4">
                        <div className="flex-1">
                            ...
                            <select
                                ...
                                value={data.category}
                                onChange={handleChange}
                                className="w-full px-4 py-3.5 bg-white border rounded-lg outline-none text-gray-800"
                                style={{ borderColor: '#E8DCC8' }}
                            >
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-4">
                            <input
                                ...
                                className="flex-1 px-4 py-3.5 bg-gray-50 border rounded-lg text-gray-600 placeholder-gray-400"
                                style={{ borderColor: '#E8DCC8' }}
                            />
                            <input
                                type="file"
                            ...
                            <label
                                ...
                                className="px-6 py-3.5 bg-[#8B7355] text-white font-medium rounded-lg cursor-pointer"
                            >
                                Upload Image
                            </label>
                        </div>
                    ...
                    <div>
                        ...
                        >
                            {loading ? 'Adding...' : 'Add Product'} {/* ✅ show loading text */}
                        </button>
                    </div>
                </div>
            </div>
