...
export const sendEmail = createAsyncThunk(
  ...
  async (
    ...
    try {
      await axios.post(
        "http://localhost:5678/webhook/cca321a2-6d6f-44ad-9336-a3f6713ba70c",
        {
          name,
          email,
          city,
...
export const sendEmailContact = createAsyncThunk(
  ...
  async (
    ...
    try {
      await axios.post(
        "http://localhost:5678/webhook/4f86d337-2beb-4853-ac9f-bbd85365c1c4",
        contactObject
      );
    } catch (error) {
      return thunkAPI.rejectWithValue(error.message);
